...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'firstName', 'lastName', 'email', 'password', 'countryCode', 'number', 'image', 'coverImage', 'theme_id', 'role_id', 'address', 'gender_id', 'birthDate', 'profession', 'aboutMe', 'userName', 'recipientId'
    ];
