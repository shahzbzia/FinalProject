...
<div class="container">
    ...
    <form class="px-6 pt-6 pb-8 mb-4" method="POST" enctype="multipart/form-data" action="{{ route('updatePost', $post->id) }}">
        ...
        <div class="flex items-center justify-between">
            ...
            <button class="hover:bg-{{ Auth::user()->theme->value }}-700 bg-{{ Auth::user()->theme->value }}-500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">
                Update
            </button>
