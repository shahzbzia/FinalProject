...
{{--             <li class="text-sm pb-4">
    ...
    <section class="mb-8">
        ...
        <ul class="list-none">
            ...
            <li class="text-sm pb-4">
                <a class="{{-- @if (Route::currentRouteName() == 'user.showUserEditForm') text-{{Auth::user()->theme->value}}-500 font-bold @else text-black @endif --}} hover:no-underline hover:text-{{Auth::user()->theme->value}}-500" href="">Edit Profile</a>
            </li>
        </ul>
