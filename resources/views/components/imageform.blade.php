<form class="px-6 pt-6 pb-8 mb-4" method="POST" enctype="multipart/form-data" action="{{ route('image.createPost') }}">
    ...
    <div class="mb-4">
        ...
        <div class="flex flex-col md:flex-row justify-between">
            <div class="flex">
                ...
                <div id="slugText" class="slugText overflow-hidden">{{ config('app.url') }}/<span id="slugLink" class="slugLink"></span></div>
            </div>
    ...
    <div class="flex items-center justify-between">
        ...
        <button class="hover:bg-{{ Auth::user()->theme->value }}-700 bg-{{ Auth::user()->theme->value }}-500 hover:text-gray-900 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">
            Post
        </button>
