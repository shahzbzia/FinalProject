        ...
        <div class="bg-white shadow-xl rounded-lg mt-2 px-8 pt-6 pb-8 mb-4">
            <ul class="flex flex-col md:flex-row lg:flex-row xl:flex-row items-center">
                <li class="flex-1 mt-1 lg:mr-10">
                    <button id="defaultOpenImage" class="tablinks px-24 md:px-24 lg:px-32 xl:px-32 text-center block border border-black rounded py-2 text-black focus:outline-none flex" onclick="openForm(event, 'image')">
                ...
                <li class="flex-1 mt-1">
                    <button id="defaultOpenVideo" class="tablinks px-24 md:px-24 lg:px-32 xl:px-32 text-center block border border-black rounded text-black py-2 focus:outline-none flex" onclick="openForm(event, 'video')">
...
<script>
    ...
    document.getElementById("defaultOpenImage").click();
